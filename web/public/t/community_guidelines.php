...
<?php
	$__server->page_embeds->page_title = "YouTube - Community Guidelines";
						...
						<div class="ytg-fl browse-content">
							...
							<div id="browse-main-column" style="float: right;margin: 0px 0 0 14px;" class="ytg-4col">
								<div class="browse-collection  has-box-ad">
                                    <h1>Community Guidelines</h1><hr>
                                    <p class="intro-text" style="line-height: 18px;margin-bottom: 20px;">
                                        Don’t spam. Don’t be a jerk. If you see something, report it to the Discord.<br>
                                        Treat others with respect and use common sense.
                                    </p>
                                </div>
							</div>
						</div>
