...
?>
<?php
	$__server->page_embeds->page_title = "TuTub - " . htmlspecialchars($_user['username']);
...
<html dir="ltr" xmlns:og="http://opengraphprotocol.org/schema/" lang="en">
	...
	<head>
		...
		<script src="//s.ytimg.com/yt/jsbin/plupload.full.min.js"></script>
        ...
        <link rel="stylesheet" href="//s.ytimg.com/yt/cssbin/www-channels3-vfl-wJB5W.css">
        <link rel="stylesheet" href="//s.ytimg.com/yt/cssbin/www-the-rest-vflNb6rAI.css">
										...
										<div class="upper-section clearfix">
											...
											<?php if($_user['username'] != @$_SESSION['siteusername']) { ?>
												...
												<?php if($__user_h->if_partner($_user['username'])) { ?>
													<img style="width: 29px;vertical-align: middle;margin-left: 10px;" title="This user is a SubRocks partner" src="//s.ytimg.com/yt/imgbin/RenderedImage.png">
												<?php } ?>
											</div>
