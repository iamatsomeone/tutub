...
<?php
	$__server->page_embeds->page_title = "YouTube - About";
							...
							<div id="browse-main-column" style="float: right;margin: 0px 0 0 14px;" class="ytg-4col">
								<div class="browse-collection  has-box-ad">
									...
									<p class="intro-text" style="line-height: 18px;margin-bottom: 20px;">
										Founded in May 2022, TuTub allows hundreds of people to discover, watch and share (mostly) originally-created videos.
										TuTub provides a forum for people to connect, inform, and inspire others across the globe and acts as a distribution platform for original content creators. 
										TuTub is the direct successor of BetterSubRocks, which shut down due to no motivation.<br><br>
										The TuTub staff team hopes you enjoy your time on this small site.
									</p>
                                </div>
							</div>
						</div>
