...
<?php
	$__server->page_embeds->page_title = "YouTube - Upload Video";
                    ...
                    <div class="upload-div-base">
                        ...
                        <div class="www-upload-left">
                            <center id="initial-upload">
                                <img src="//s.ytimg.com/yt/imgbin/upload_button.png" onclick="$('#video-file').click();" style="width: 139px;cursor:pointer;"><br><br>
