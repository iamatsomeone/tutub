...
<?php
	$__server->page_embeds->page_title = "TuTub - Replace me";
	$__server->page_embeds->page_description = "You DON'T deserve to be here if you got into this mess.";
		...
		<div id="page" class="">
			...
			<div id="content-container">
				...
				<div id="content">
                    ...
                    <p>
                        You may not continue to view TuTub.
                    </p><br>
                    <br><br>
                </div>
            </div>  
