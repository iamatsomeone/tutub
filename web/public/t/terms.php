...
<?php
	$__server->page_embeds->page_title = "YouTube - Terms & Conditions";
...
<html dir="ltr">
	<head>
		...
		<link rel="stylesheet" href="//s.ytimg.com/yt/cssbin/www-videos-nav-vflYGt27y.css">
        	<link rel="stylesheet" href="//s.ytimg.com/yt/cssbin/www-extra.css">
		<link rel="stylesheet" href="//s.ytimg.com/yt/cssbin/www-inbox.css">
						...
						<div class="ytg-fl browse-content">
							...
							<div id="browse-main-column" style="float: right;margin: 0px 0 0 14px;" class="ytg-4col">
								<div class="browse-collection  has-box-ad">
                                    ...
                                    <p class="intro-text" style="line-height: 18px;margin-bottom: 20px;">By accessing this Website, accessible from http://subrock.rocks, you are agreeing to be bound by these Website Terms and Conditions of Use and agree that you are responsible for the agreement with any applicable local laws. If you disagree with any of these terms, you are prohibited from accessing this site. The materials contained in this Website are protected by copyright and trade mark law.</p>

                                    <h2>2. Disclaimer</h2>

                                    <p class="intro-text" style="line-height: 18px;margin-bottom: 20px;">All the materials on TuTub’s Website are provided "as is". TuTub makes no warranties, may it be expressed or implied, therefore negates all other warranties. Furthermore, TuTub does not make any representations concerning the accuracy or reliability of the use of the materials on its Website or otherwise relating to such materials or any sites linked to this Website.</p>

                                    <h2>3. Limitations</h2>

                                    <p class="intro-text" style="line-height: 18px;margin-bottom: 20px;">TuTub or its suppliers will not be hold accountable for any damages that will arise with the use or inability to use the materials on TuTub’s Website, even if TuTub or an authorize representative of this Website has been notified, orally or written, of the possibility of such damage. Some jurisdiction does not allow limitations on implied warranties or limitations of liability for incidental damages, these limitations may not apply to you.</p>

                                    <h2>4. Quality Control</h2>

                                    <p class="intro-text" style="line-height: 18px;margin-bottom: 20px;">TuTub or its suppliers will remove your video/content if it is considered low effort by the staff team without any warning.</p>

                                    <h2>5. Revisions and Errata</h2>

                                    <p class="intro-text" style="line-height: 18px;margin-bottom: 20px;">The materials appearing on TuTub’s Website may include technical, typographical, or photographic errors. TuTub will not promise that any of the materials in this Website are accurate, complete, or current. TuTub may change the materials contained on its Website at any time without notice. TuTub does not make any commitment to update the materials.</p>

                                    <h2>6. Links</h2>

                                    <p class="intro-text" style="line-height: 18px;margin-bottom: 20px;">TuTub has not reviewed all of the sites linked to its Website and is not responsible for the contents of any such linked site. The presence of any link does not imply endorsement by TuTub of the site. The use of any linked website is at the user’s own risk.</p>

                                    <h2>7. Site Terms of Use Modifications</h2>

                                    <p class="intro-text" style="line-height: 18px;margin-bottom: 20px;">TuTub may revise these Terms of Use for its Website at any time without prior notice. By using this Website, you are agreeing to be bound by the current version of these Terms and Conditions of Use.</p>

                                    <h2>8. Copyright</h2>

                                    <p class="intro-text" style="line-height: 18px;margin-bottom: 20px;">Please read our copyright policy.</p><br><br>
                                </div>
							</div>
						</div>
					</div>
