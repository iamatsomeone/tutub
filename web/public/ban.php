...
<?php
	$__server->page_embeds->page_title = "TuTub - Broadcast Themself";
	$__server->page_embeds->page_description = "You got yoself into trouble mate.";
			...
			<div id="content-container">
				...
				<div id="content">
                    <div style="width: 410px;margin: auto;">
                        <h1>Banned</h1><br>
                        We do not tolerate this kind of behavior here at <br>TuTub.<br> If you make another account, it will also be banned for ban evaision.<br><br>
                        ...
                        <a href="/ban_logout"><button class="yt-uix-button yt-uix-button-default">Log Out</button></a>
                    </div><br>
                </div>
            </div>  
